...
const WeekCalendarView: React.FC<WeekCalendarViewProps> = ({
  ...
  const bodyHeight =
    totalHours * HOUR_HEIGHT + CALENDAR_PADDING_TOP + CALENDAR_PADDING_BOTTOM;
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <View
          style={[styles.body, { height: bodyHeight - CALENDAR_PADDING_TOP }]}
        >
          {/* Colonne des heures */}
          <View
            style={[
          ...
          >
            {timeSlots.map((slot, index) => (
              <View
                key={slot.hour}
                style={[styles.timeSlot, { top: index * HOUR_HEIGHT - 8 }]}
              >
