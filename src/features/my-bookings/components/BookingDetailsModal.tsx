                    ...
                    >
                        ...
                        <View style={styles.notesSection}>
                                ...
                                {canEdit && (
                                    ...
                                    >
                                        <Icons.PencilSimpleIcon
                                            ...
                                            color={colors.accent.primary}
                                        />
                                        <Typo size={13} color={colors.accent.primary} fontWeight="500">
                                            Modifier
                                        </Typo>
                                    </Pressable>
                                )}
                            ...
                            >
                                <Typo
                                    ...
                                    style={{ fontStyle: booking.participantsNotes ? "normal" : "italic" }}
                                >
                        ...
                        {!isPast && booking.participantStatus !== "CANCELLED" && (
                            ...
                            >
                                <Icons.InfoIcon
                                    size={18}
                                    color={canCancel ? colors.semantic.info : colors.semantic.warning}
                                    weight="fill"
                                />
                                <Typo
                                    size={12}
