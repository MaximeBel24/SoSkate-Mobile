...
export default function InstructorCoursesScreen() {
    ...
    // DERIVED DATA
    // ============================================
    const currentCourses = activeTab === "upcoming" ? upcomingCourses : passedCourses;
    const isLoading = activeTab === "upcoming" ? isLoadingUpcoming : isLoadingPassed;
    const isRefreshing = activeTab === "upcoming" ? isRefreshingUpcoming : isRefreshingPassed;
            ...
            >
                ...
                {!isLoadingStats && stats && (
                    ...
                    >
                        ...
                        />
                        <View
                            style={[styles.statDivider, { backgroundColor: colors.border.subtle }]}
                        />
                        <StatItem
                            label="À venir"
                ...
                {error && (
                    <View style={styles.errorBanner}>
                        <Icons.WarningCircle
                            ...
                            weight="fill"
                        />
                        <Typo size={13} color={colors.semantic.danger} style={styles.errorText}>
                            {error}
                        </Typo>
