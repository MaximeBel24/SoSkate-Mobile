...
interface UseAvailabilityReturn {
    ...
    fetchSlotsForDate: (date: string, durationMinutes: number) => Promise<TimeSlot[]>;
...
export const useAvailability = ({
    ...
    const [availabilitiesByDate, setAvailabilitiesByDate] = useState<Map<string, AvailabilityResponse[]>>(new Map());
